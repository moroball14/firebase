...
exports.api = functions.https.onRequest((request, response) => {
  ...
  response.send(encodeURIComponent(functions.config().api.google_maps));
 });
...
exports.timetableapi = functions.https.onRequest((request,response) => {
  ...
  let stoptimesurl = 'https://firebasestorage.googleapis.com/v0/b/train-time-api-7eb0f.appspot.com/o/'+request.query.agency_id+'%2Fstop_times.json?alt=media';
  let calendarurl = 'https://firebasestorage.googleapis.com/v0/b/train-time-api-7eb0f.appspot.com/o/'+request.query.agency_id+'%2Fcalendar.json?alt=media';
  let calendar_datesurl = 'https://firebasestorage.googleapis.com/v0/b/train-time-api-7eb0f.appspot.com/o/'+request.query.agency_id+'%2Fcalendar_dates.json?alt=media';
  let tripsurl = 'https://firebasestorage.googleapis.com/v0/b/train-time-api-7eb0f.appspot.com/o/'+request.query.agency_id+'%2Ftrips.json?alt=media'; 
...
exports.aroundstops = functions.https.onRequest((request,response) => {
  ...
  var url = 'https://firebasestorage.googleapis.com/v0/b/train-time-api-7eb0f.appspot.com/o/'+request.query.agency_id+'%2Fstops.json?alt=media';
